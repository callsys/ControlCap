...
from controlcap_inference import ControlCap
...
def predict(img, pointed_mask, select):
    if pointed_mask is not None:
        caption = controlcap.predict(img, pointed_mask)
        return caption
    else:
...
with gr.Blocks(title="Controlcap") as demo:
    ...
    # example_list = None
    example_list = [
        [os.path.join(os.path.dirname(__file__), 'demo.jpg')],
        [os.path.join(os.path.dirname(__file__), 'demo/demo.jpg')],
    ...
    with gr.TabItem("point-prompt"):
        ...
        with gr.Row():
            with gr.Column():
                ...
                # point prompt
                radio_1 = gr.Radio(label='type', choices=['short description', 'detailed description'],
    ...
    with gr.TabItem("box-prompt"):
        with gr.Row():
            with gr.Column():
                ...
                radio_3 = gr.Radio(label='type', choices=['short description', 'detailed description'],
                                   value='short description')
    ...
    with gr.TabItem("segment everything"):
        with gr.Row():
            with gr.Column():
                ...
                radio_2 = gr.Radio(label='type', choices=['short description', 'detailed description'],
                                   value='short description')
